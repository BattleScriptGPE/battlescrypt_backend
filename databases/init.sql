GRANT ALL PRIVILEGES ON *.* TO 'gpe'@'172.17.0.1' IDENTIFIED BY 'XZe&pR5%2397' WITH GRANT OPTION;
GRANT ALL PRIVILEGES ON *.* TO 'gpe'@'54.36.101.183' IDENTIFIED BY 'XZe&pR5%2397' WITH GRANT OPTION;
GRANT CREATE, ALTER, DROP, INSERT, UPDATE, DELETE, SELECT, REFERENCES, RELOAD on *.* TO 'gpe'@'54.36.101.183' WITH GRANT OPTION;
GRANT CREATE, ALTER, DROP, INSERT, UPDATE, DELETE, SELECT, REFERENCES, RELOAD on *.* TO 'gpe'@'172.17.0.1' WITH GRANT OPTION;
FLUSH PRIVILEGES;
CREATE TABLE `user`
(
